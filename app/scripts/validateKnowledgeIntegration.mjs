...
try {
  ...
  assert(guides.length === 330, `Expected 330 Chat guides, received ${guides.length}`);
  assert(conditions.length === 330, `Expected 330 Learn conditions, received ${conditions.length}`);
