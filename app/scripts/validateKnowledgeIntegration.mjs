...
try {
  ...
  assert(guides.length === 700, `Expected 700 Chat guides, received ${guides.length}`);
  assert(conditions.length === 700, `Expected 700 Learn conditions, received ${conditions.length}`);
