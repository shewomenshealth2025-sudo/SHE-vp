...
try {
  ...
  assert(guides.length === 598, `Expected 598 Chat guides, received ${guides.length}`);
  assert(conditions.length === 598, `Expected 598 Learn conditions, received ${conditions.length}`);
