...
try {
  ...
  assert(guides.length === 562, `Expected 562 Chat guides, received ${guides.length}`);
  assert(conditions.length === 562, `Expected 562 Learn conditions, received ${conditions.length}`);
