...
try {
  ...
  assert(guides.length === 574, `Expected 574 Chat guides, received ${guides.length}`);
  assert(conditions.length === 574, `Expected 574 Learn conditions, received ${conditions.length}`);
